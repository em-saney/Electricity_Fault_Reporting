...
//   title: 'Log in - EFRS',
//   description: 'Electricity Fault Reporting System ',
// }
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12">
        <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
          ...
          <div className="flex items-center justify-center">
            ...
            <Link
              href="/fault"
              className="inline-block c px-8 md:px-12 hover:bg-green-700 text-white font-bold py-2 rounded focus:outline-none focus:shadow-outline"
            >
              Login
            </Link>
          </div>
